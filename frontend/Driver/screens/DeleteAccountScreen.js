...
export default function DeleteAccountScreen({ driverProfile, authTokenRef, getHeaders, navigateTo, navigation }) {
      ...
      <View style={{ flex: 1, backgroundColor: P.bg }}>
        ...
        <ScrollView contentContainerStyle={st.scroll} showsVerticalScrollIndicator={false}>
          <View style={st.dangerBox}>
            ...
            <Text style={st.dangerTitle}>Permanent Deletion</Text>
          ...
          >
            {loading
              ...
              : <><Ionicons name="trash-outline" size={18} color="#fff" /><Text style={st.actionBtnTxt}>Delete Account Permanently</Text></>
            }
          </TouchableOpacity>
...
const st = StyleSheet.create({
  ...
  dangerBox: { backgroundColor: '#FFEBEE', borderRadius: 16, padding: 18, marginBottom: 24, alignItems: 'center', borderWidth: 1, borderColor: '#FFCDD2', gap: 10 },
